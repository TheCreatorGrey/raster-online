...
function updateCanvasPosition() {
    workarea.style.left = canvasPosition[0] + ((document.body.clientWidth/2)-(workarea.clientWidth/2));
    workarea.style.top = canvasPosition[1] + ((document.body.clientHeight/2)-(workarea.clientHeight/2));
}
...
document.body.onwheel = function (event) {
    ...
    workarea.style.width = bounding.width * canvasZoom;
    workarea.style.height = bounding.height * canvasZoom;
